...
export const metadata: Metadata = {
  title: "SARASnova — AI CFO for Indian Businesses",
  description:
    "SARASnova connects with Tally, reads your data in real-time, and turns it into clarity, insights, and action—every single day for Indian businesses.",
  keywords: [
    "AI CFO",
    "Tally integration",
  ...
  openGraph: {
    title: "SARASnova — AI CFO for Indian Businesses",
    description:
      "Turn financial & operational data into clear insights, risks and actions with SARASnova.",
