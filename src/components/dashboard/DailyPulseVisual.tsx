  ...
  return (
    <div className="w-full h-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 sm:p-7 shadow-2xl flex flex-col justify-between font-sans text-slate-900 dark:text-white transition-colors">
      ...
      <div className="p-4 sm:p-5 rounded-2xl bg-slate-950 text-slate-100 border border-slate-800 space-y-3.5 my-3 shadow-xl">
        <div className="flex items-center justify-between border-b border-slate-800 pb-2.5">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <div className="text-[10px] text-indigo-400 font-semibold">Tally Ledger Sync Active</div>
            </div>
          </div>
        ...
        <div className="text-xs sm:text-sm text-slate-200 space-y-2 leading-relaxed">
          ...
          <div className="space-y-2 pt-1 text-xs">
            ...
            <div className="flex items-center justify-between bg-slate-900 p-2.5 rounded-xl border border-slate-800">
              ...
              <span className="font-extrabold text-purple-400">₹2.50L</span>
            </div>
            <div className="flex items-center justify-between bg-slate-900 p-2.5 rounded-xl border border-slate-800">
        ...
        {/* Action Button */}
        <button className="w-full py-2.5 px-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-xs sm:text-sm flex items-center justify-center gap-2 transition-colors shadow-lg shadow-indigo-900/30">
      ...
      <div className="pt-3 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs">
        <span className="text-slate-500 dark:text-slate-400 font-medium flex items-center gap-1.5">
          <CheckCircle2 className="w-4 h-4 text-indigo-500" /> Zero App Fatigue • No Login Required
        </span>
