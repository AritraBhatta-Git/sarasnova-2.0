  ...
  return (
    <div className="w-full h-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 sm:p-7 shadow-2xl flex flex-col justify-between font-sans text-slate-900 dark:text-white transition-colors">
      ...
      <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
        ...
        <div className="hidden sm:flex items-center gap-1.5 text-xs font-bold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/60 px-3 py-1 rounded-full border border-blue-200 dark:border-blue-800">
      ...
      <div className="space-y-4 my-4">
        ...
        <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/90 border border-slate-200 dark:border-slate-800/80 space-y-2 hover:border-indigo-500/40 transition-colors">
          <div className="flex items-center justify-between text-xs sm:text-sm font-bold">
            ...
            <span className="text-xs font-extrabold text-purple-600 dark:text-purple-400 flex items-center gap-0.5">
          ...
          <div className="flex items-baseline justify-between text-xs text-slate-500 dark:text-slate-400">
            ...
            <span className="font-black text-purple-600 dark:text-purple-400">112% Achieved</span>
          </div>
        ...
        <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950/90 border border-slate-200 dark:border-slate-800/80 space-y-2 hover:border-indigo-500/40 transition-colors">
          <div className="flex items-center justify-between text-xs sm:text-sm font-bold">
            ...
            <span className="text-xs font-extrabold text-purple-500 dark:text-purple-300 flex items-center gap-0.5">
              <ArrowDownRight className="w-4 h-4" /> +4 Days Variance Slip
            </span>
          </div>
          <div className="flex items-baseline justify-between text-xs text-slate-500 dark:text-slate-400">
            <span>Actual: 42 Days / Target: 38 Days</span>
            <span className="font-black text-purple-500 dark:text-purple-300">Course Correcting</span>
          </div>
          <div className="w-full bg-slate-200 dark:bg-slate-800 h-2 rounded-full overflow-hidden">
            <div className="bg-purple-400 h-full rounded-full w-[78%]" />
          </div>
        </div>
      </div>
      ...
      <div className="p-3.5 rounded-xl bg-indigo-50/80 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800/60 flex items-center justify-between text-xs">
        ...
        <span className="font-black text-indigo-600 dark:text-indigo-400 flex items-center gap-1">
          <CheckCircle2 className="w-4 h-4 text-indigo-500" /> Auto-Synced
        </span>
      </div>
    </div>
  );
