...
export function PhoneMockup() {
  return (
    <div className="relative w-full max-w-[310px] xs:max-w-[340px] sm:max-w-[380px] mx-auto">
      ...
      <div className="relative rounded-[44px] border-[6px] border-slate-800 dark:border-slate-800 bg-slate-950 shadow-2xl overflow-hidden font-sans">
        {/* Notch / Speaker */}
        ...
        <div className="pt-6 pb-5 px-4 space-y-3 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-100 min-h-[580px]">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="p-2.5 rounded-xl bg-slate-900/90 border border-slate-800 space-y-1">
              ...
              <div className="text-[9px] text-emerald-400 font-semibold flex items-center gap-0.5">
                <ArrowUpRight className="w-2.5 h-2.5 text-emerald-400" /> +408.2% vs last mo
              </div>
            </div>
          ...
          {/* Urgent Alert Card */}
          <div className="p-3 rounded-2xl bg-rose-950/50 border border-rose-500/40 text-rose-200 space-y-1">
          ...
          {/* Ask SARAS Bar */}
          <div className="p-2.5 rounded-xl bg-slate-900 border border-purple-500/30 flex items-center justify-between text-purple-200">
