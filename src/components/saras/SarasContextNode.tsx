...
export function SarasContextNode({
  ...
  const colorMap = {
    purple: "border-purple-500/30 text-purple-400 bg-purple-950/60 shadow-purple-500/10",
    blue: "border-blue-500/30 text-blue-400 bg-blue-950/60 shadow-blue-500/10",
    green: "border-emerald-500/30 text-emerald-400 bg-emerald-950/60 shadow-emerald-500/10",
    amber: "border-amber-500/30 text-amber-400 bg-amber-950/60 shadow-amber-500/10",
    rose: "border-rose-500/30 text-rose-400 bg-rose-950/60 shadow-rose-500/10",
  };
