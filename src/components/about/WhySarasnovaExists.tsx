    ...
    <section id="why-sarasnova" className="py-16 md:py-24 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white scroll-mt-24 transition-colors">
      <Container size="xl" className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Problem */}
          <div className="p-8 rounded-3xl border border-rose-200 dark:border-rose-500/30 bg-white dark:bg-slate-900/90 space-y-4 shadow-md dark:shadow-none">
          ...
          {/* Solution */}
          <div className="p-8 rounded-3xl border border-purple-200 dark:border-purple-500/30 bg-white dark:bg-slate-900/90 space-y-4 shadow-md dark:shadow-none">
            <div className="p-3 rounded-2xl bg-purple-100 dark:bg-purple-950/60 border border-purple-200 dark:border-purple-500/40 text-purple-600 dark:text-purple-400 w-fit">
              <CheckCircle2 className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-extrabold text-slate-900 dark:text-white">The Sarasnova 2.0 Reality</h3>
            <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
